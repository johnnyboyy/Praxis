...
case "$VERDICT" in
  ...
  deny)
    ...
    ;;
  no_unit)
    deny "No open unit of work in the journal for this root ($ROOT_PATH) — call the praxis-front-door begin_work tool for this unit of work before editing (praxis/SKILL.md: 'frame before acting')."
    ;;
  *)
