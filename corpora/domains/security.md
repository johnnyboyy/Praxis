...
- id: scope-iac-permissions-to-stated-need
  ...
  see-also: gate-and-flag-security-check-bypass, fix-implementation-not-security-assertion
...
- id: gate-and-flag-security-check-bypass
  ...
  see-also: terminal-checkpoint-pass, scope-iac-permissions-to-stated-need, fix-implementation-not-security-assertion
...
- id: fix-implementation-not-security-assertion
  ...
  see-also: gate-and-flag-security-check-bypass, scope-iac-permissions-to-stated-need
...
- id: verify-dependency-currency-not-familiarity
  ...
  see-also: hardened-defaults-for-scaffolded-services
...
- id: hardened-defaults-for-scaffolded-services
  ...
  see-also: verify-dependency-currency-not-familiarity
