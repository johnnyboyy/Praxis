...
subject: coding
posture: guardrail
units-of-work: [implement-feature, debug-issue, scaffold-tests, verify-scaffold, triage-scaffold]
universal: false
---
...
distinct from `coding-general`/stack-specific coding domains' implementation judgment. This file is
the judgment; `praxis-plugin/phases/runtime-verification.md` and the `testing` phase are the
processes that apply it. Seeding provenance (2026-07-29 exercise run) and audit metadata live in
